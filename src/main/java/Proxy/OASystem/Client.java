package Proxy.OASystem;

import Proxy.OASystem.dao.AbstractDocumentDAO;
import Proxy.OASystem.dao.AbstractUserDAO;
import Proxy.OASystem.dao.DocumentDAO;
import Proxy.OASystem.dao.UserDAO;
...
public class Client {
    public static void main(String[] args) {
        ...
        proxy = (AbstractUserDAO)Proxy
                .newProxyInstance(AbstractUserDAO.class.getClassLoader(),
